    ...
    ALGO_CONFIG: {
        ...
        knapsack: {
            ...
            params: [
                ...
                {name: 'capacity', type: 'text', defaultValue: '60 100 120'},
                {name: 'capacity', type: 'number', defaultValue: 50}
...
describe('ControlPanel',() => {
    ...
    test('renders with initial props', () => {
        ...
        expect(screen.getByText('Reset')).not.toBeEnabled();
    });
    ...
    test('calls setProblem and resets state when problem is changed', () => {
        ...
        expect(mockProps.setParams).toHaveBeenCalledWith({capacity: "50", values: '60, 100, 120', weights: '10, 20, 30'});
